class TankLevelWidget {

  static install(signalkClient, container=window.document.body) {
    return(new TankLevelWidget(signalkClient, container));
  }
  ...
  constructor(signalkClient, container) {
    ...
    var tankChart = PageUtils.createElement('div', null, 'tanklevelwidget', null, container);
  ...
  makeTankBar(tank) {
    var tankBar = PageUtils.createElement('div', tank.path, 'tanklevelwidget-bar', null, null);
  ...
  makePopup() {
    this.popup.container = PageUtils.createElement('div', 'tanklevelwidget-popup', 'hidden', null, null);
